function run_nonlinear_operator_tests()
    ...
    return @testset "Nonlinear Operator" begin
        println("\n")
        println("==========================")
        println("Testing Nonlinear Operator")
        println("==========================")

        @test TestLinearNonlinearOperator() < 1.0e-14
        @test TestParallelAssemblyNonlinearOperator() < 2.0e-13
    end
end
